        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountStats = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteCategorias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteCategorias_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteCategorias_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCategorias_CategoryId",
                table: "FavoriteCategorias",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCategorias_UserId",
                table: "FavoriteCategorias",
                column: "UserId");
